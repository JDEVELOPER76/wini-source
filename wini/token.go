...
func compilarTokens() []DefinicionToken {
	return []DefinicionToken{
		...
		{PALABRA_CLAVE, regexp.MustCompile(`\b(escribir|sino|si|leer|funcion|retornar|tipo|importar|mientras|para|romper|continuar|intentar|capturar|finalmente|lanzar|como)\b`)},
